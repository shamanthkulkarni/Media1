...
public class CustomAdapterVideo extends ArrayAdapter<String> {

    private MyDatabaseHandler db = new MyDatabaseHandler(getContext());
    public CustomAdapterVideo(Context context, ArrayList<String> anyfile) {
    ...
    public View getView(int position1, View convertView, ViewGroup parent) {
        ...
        itemimage.setImageResource(R.drawable.videoicon);
        return customView;
    }
